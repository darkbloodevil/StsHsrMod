 ...
 * @description
 */
public class FireflyTypeIVPyrogenicDecimation extends BaseCard {
    public static final String ID = makeID(FireflyTypeIVPyrogenicDecimation.class.getSimpleName());
    ...
    public FireflyTypeIVPyrogenicDecimation() {
        super(ID, info);
