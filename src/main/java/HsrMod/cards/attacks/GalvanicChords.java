 ...
 * @description
 */
public class GalvanicChords extends BaseAttack implements ToughnessReductionInterface {
    public static final String ID = makeID(GalvanicChords.class.getSimpleName());
